...
<div class="container">
    ...
    <form id="filter" class="form-horizontal">
        ...
        <button type="button" onclick="resetFilter()">Очистить</button>
        <button type="button" onclick="updateTable()"><spring:message code="meals.filter"/></button>
    </form>
                    </div>
                </div>
            </div>
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td><a class="btn btn-xs btn-primary">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true" id="${meal.id}"></span>
                </a></td>
